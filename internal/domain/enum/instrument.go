...
const (
	SecurityTradingStatus_UNSPECIFIED                      SecurityTradingStatus = iota // Торговый статус не определён.
...
const (
	RealExchange_UNSPECIFIED RealExchange = iota // Тип не определён.
...
const (
	InstrumentType_UNSPECIFIED          InstrumentType = iota
